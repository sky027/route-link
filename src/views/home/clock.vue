<template>
  <div class="box" id="clock" :title="current">
    <!-- 原点 -->
...
<style scoped lang="scss">
  .box{ width: 400px; height: 400px; border:10px solid #8bf2f1;border-radius: 50%; font-size: 14px;
    box-shadow: 0 0 20px 3px #444 inset; position: relative;}
  /*原点*/
  ...
  .date_info{width:160px;height:28px;
    ...
    font-weight:bold;}
  .time_info{display: flex;width: 110px; height: 35px; line-height: 35px;text-align:center;position:absolute;top:270px;left:150px;z-index:11;color:#06f3c3;}
  .time{ width: 27px ;height:35px; font-size: 22px;}
